...
def save_results(df, configs, methodtype):
    ...
    path = os.path.join('/home/emil/EmoCog/data/new_labels/results/', str(configs['patient']), methodtype)
    if not os.path.exists(path):
        os.makedirs(path)
    link = os.path.join('/home/emil/EmoCog/data/new_labels/results/', str(configs['patient']), methodtype, fname)
    df.to_hdf(link, key='df')
...
def save_processing_tools(pca, artifact_paras, standard_paras, good_chans, configs):
    ...
    if not os.path.exists(os.path.join('/home/emil/EmoCog/data/new_labels/pca_models', str(configs['patient']))):
        os.mkdir(os.path.join('/home/emil/EmoCog/data/new_labels/pca_models', str(configs['patient'])))
    link = os.path.join('/home/emil/EmoCog/data/new_labels/pca_models', str(configs['patient']), fname)
...
def save_classifier(classifier, best_thr, configs, methodtype):
    ...
    """
    fname = generate_filename(configs) + '.pkl'
    if not os.path.exists(os.path.join('/home/emil/EmoCog/data/new_labels/classifier', str(configs['patient']), methodtype)):
        os.makedirs(os.path.join('/home/emil/EmoCog/data/new_labels/classifier', str(configs['patient']), methodtype))
    link = os.path.join('/home/emil/EmoCog/data/new_labels/classifier', str(configs['patient']), methodtype, fname)
